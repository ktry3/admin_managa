    ...
    <Box className='g-padding py-[5%] bg-[url("https://www.digitalocean.com/_next/static/media/benefits-bg.d8486e3e.svg")]'>
      <Grid container justifyContent="center" spacing={5}>
        <Grid item xs={6} className="text-center">
          ...
          <Typography variant="body2" className="text-[1rem] text-gray-500">
            ...
            growing businesses, DigitalOcean cloud is built to serve the unique
            needs of startups and SMBs.
          </Typography>
        </Grid>
        <Grid item xs={12} className="g-padding" sx={{ height: 600 }}>
      ...
      <Box className="mt-[10%] g-padding">
        <ImageCard
          cardShadow
          containerStyle={
            "bg-[rgb(0,44,155)] text-white p-[2rem] benefit-section-temp"
          }
