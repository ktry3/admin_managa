        ...
        <Grid item xs={12} className='mb-[3%]'>
          <Grid container direction='column' spacing={2}>
            <Grid item className='text-center' xs={12}>
              ...
              <div className='py-4'>
                <p>Meeting The Best Application For Data Colletion Across Cambodia.</p>
                <br></br>
                <p>Build your vision using SrongDATA, a powerful and cost-effective data collection solutions.</p>
              </div>
            </Grid>
            <Grid item xs={12}>
